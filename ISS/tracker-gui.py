...
while (loop == 2):
    ...
    def exit_program():
        image = "/Users/emilianogonzalezbadillo/Desktop/ISS-TRACKER/ISS/warning.png"
    ...
    def main_menu():
        ...
        image = "/Users/emilianogonzalezbadillo/Desktop/ISS-TRACKER/ISS/iss.png"
        ...
        if choice == "ISS Tracker":
            def ISS_Tracker():
                title = "ISS Tracker Program"
                image = 'notes.png'
                iss = '/Users/emilianogonzalezbadillo/Desktop/ISS-TRACKER/ISS/copia_ISS.png'
                image2 = '/Users/emilianogonzalezbadillo/Desktop/ISS-TRACKER/ISS/warning2.png'
                gnome_msg = ("You accessed the ISS Tracker program!")
                gnome_buttons = ["Run ISS Tracker", "<- Back to Main screen", "View ISS current coordinates",
                                 "Show ISS location in Google Maps", "Spot the ISS at spotthestation.nasa.gov/tracking_map.cfm", "Exit Program"]
                    ...
                    def ISS_Settings():
                        ...
                        if pictures == None:
                            ...
                            def Interval_time():
                                ...
                                global seconds
                                seconds = integerbox("--> Amount of pictures to take: "+str(
                                ...
                                if seconds == None or seconds == 0:
                                    ...
                                    title = "Cancel operation?"
                                    choices = [
                                        "Yes", "No", "<-- Back to Amount of Pictures screen", "EXIT PROGRAM"]
                                    choice = buttonbox(
                                        msg, title, choices, image=image)
                                    if choice == "Yes":
                                        ISS_Tracker()
                                ...
                                if seconds > 0:
                                    ...
                                    def data_provided():
                                        ...
                                        yes_no_buttons = [
                                            'RUN PROGRAM NOW', '<-- Back to amount of pictures screen', '<-- Back to seconds interval screen', "EXIT PROGRAM"]
                                        choice = buttonbox(
                                            message, title, yes_no_buttons, image=timer)
                                        if choice == "RUN PROGRAM NOW":
                                            ...
                                            def api_request_and_vars():
                                                ...
                                                # Call the webserver
                                                trackiss = urllib.request.urlopen(
                                                    eoss)
                                                ...
                                                # from 'result variable, obtain the tag 'iss_possition' into a list
                                                location = result['iss_position']
                                                timesStamp = result['timestamp']
                                                message = result['message']
                                                # these functions can be called from another function
                                                global lat, lon, comma, space, lines
                                            ...
                                            def timenow():
                                                global timenow
                                                # these functions can be called from another function
                                                global todayis, todaysdate, yymmday, hhmmss
                                                now = datetime.now()
                                                yymmday = '%s-%s-%s' % (
                                                    now.year, now.month, now.day)
                                                hhmmss = '%s:%s:%s' % (
                                                ...
                                                todayis = (
                                                    str(yymmday)+"-"+str(hhmmss))
                                                print(
                                                    "Today is: "+str(yymmday)+" "+str(hhmmss))
                                                pass
                                            ...
                                            def main_satellite():
                                                ...
                                                print(
                                                    "-------------------------------------------------")
                                                print(
                                                    "Google Maps Module accessed.")
                                                print(
                                                    "Triggering selenium webdriver to open browser...")
                                                ...
                                                for number in range(amount_of_repetitions, 0, -1):
                                                    if number == 1:
                                                        print(
                                                            "-------------------------------------------------")
                                                        print(
                                                            "Program terminated, returning to main menu again.")
                                                        print(
                                                            "-------------------------------------------------")
                                                        main_menu()
                                                        ...
                                                        while (loop == 1):
                                                            ...
                                                            for number in range(amount_of_repetitions, 0, -1):
                                                                print(
                                                                    "-------------------------------------------------")
                                                                print(
                                                                    "Amount of remaining iterations: "+str(number))
                                                                print(
                                                                    "-------------------------------------------------")
                                                                print(
                                                                    "Refresh interval in seconds set to: "+str(seconds))
                                                                print(
                                                                    "-------------------------------------------------")
                                                                print(
                                                                ...
                                                                driver.find_element_by_xpath(
                                                                    '//*[@id="searchboxinput"]').send_keys(lat+comma+space+lon)
                                                                driver.find_element_by_xpath(
                                                                    '//*[@id="searchbox-searchbutton"]').click()
                                                                print(
                                                                    "-------------------------------------------------")
                                                                cwd = os.getcwd()
                                                                path = cwd
                                                                for remaining_seconds in range(int(seconds), 0, -1):
                                                                    print(
                                                                        "Refreshing in: " + str(remaining_seconds))
                                                                    time.sleep(
                                                                        1)
                                                                    if remaining_seconds == 1:
                                                                        ...
                                                                        todayis = (
                                                                            str(yymmday)+"-"+str(hhmmss))
                                                                        name_and_path_to_screenshots = (
                                                                            datepath+"/"+str(number)+"-ISS"+"-"+str(todayis)+".png")
                                                                        driver.save_screenshot(
                                                                            name_and_path_to_screenshots)
                                                                        print(
                                                                            "The screenshot was saved to: " + name_and_path_to_screenshots)
                                                                        print(
                                                                            "-------------------------------------------------")
                                                                        if number == 1:
                                                                            print(
                                                                                "-------------------------------------------------")
                                                                            print(
                                                                                "Program finished, returning to main menu...")
                                                                            main_menu()
                                                                        else:
                                                                            print(
                                                                                "Waiting other 5 seconds to process picture in path...")
                                                ...
                                                try:
                                                    ...
                                                    if datepath == (cwd+"/"+create_folder):
                                                        ...
                                                        print(
                                                            "#################################################")
                                                        print(
                                                            "Cannot create the directory as it already exists")
                                                        print(
                                                            "The screenshots of the ISS location will be")
                                                        print(
                                                            "in the existing path: "+path+"/"+create_folder)
                                                        main_satellite()
                                                except:
                                                    ...
                                                    print(
                                                        "#################################################")
                                                    print(
                                                        "Successfully created the directory "+datepath)
                                                    print(
                                                        "The screenshots of the ISS location will be")
                                                    print(
                                                        "stored in the path created above")
                                                    main_satellite()
                                        ...
                                        if choice == "EXIT PROGRAM":
                                            ...
                                            choices = ["Yes", "No"]
                                            choice = buttonbox(
                                                msg, title, choices, image=image2)
                                            if choice == "Yes":
                                                sys.exit(0)
                                            if choice == "No":
                                                data_provided()
                ...
                if choice == "View ISS current coordinates":
                    ...
                    print(lines)
                    log.write('\n'+hashtags)
                    hours_minutes_seconds = 'Hours: ' + \
                        str(hours)+' Minutes: '+str(minutes)+'\n\n'
